(($) ->
  ...
  #  preview       # empty_seat    # playing_seat
    ...
    {pv: [178, 170], es: [116, 275], ps: [117, 230], bet: [150,288,233,208], draw: [90,30]}
    {pv: [ 78, 125], es: [173,  95], ps: [145,  60], bet: [181,122,300,175], draw: [90,40]}
    {pv: [108,  15], es: [342,  55], ps: [342,  20], bet: [376,83, 402,162], draw: [90,60]}
